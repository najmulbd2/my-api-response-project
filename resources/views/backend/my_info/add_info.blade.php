                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-11">
                            ...
                            <div id="formControls" class="mb-5">
                                <h4>Add Info<i class='bx bx-loader bx-spin text-theme fw-bold'></i></h4>
                                <div class="card">
                                        ...
                                        <form action="{{ route('store.info') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        <label class="form-label" for="exampleFormControlInput1">Designation<span class="text-danger">*</span></label>

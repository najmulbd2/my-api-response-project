        ...
        <div class="menu-item dropdown dropdown-mobile-full">
            <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
                <div class="menu-img online">
                    <img src="{{ (!empty($user->image))? url('upload/user_images'.$user->image) : url('upload/no_image.jpg') }}" alt="Profile" height="60" />
                </div>
                <div class="menu-text d-sm-block d-none">Admin</div>
            </a>
